...
"url":1,
"doc":"Execute an AuroraX request. Attributes: limited_evaluation: set this to True if you don't want to evaluate the response outside of the retry mechanism, defaults to False. Returns: An AuroraXResponse object. Raises: aurorax.exceptions.AuroraXMaxRetriesException: max retry error. aurorax.exceptions.AuroraXNotFoundException: requested resource was not found. aurorax.exceptions.AuroraXUnexpectedContentTypeException: unexpected content error. aurorax.exceptions.AuroraXUnauthorizedException: invalid API key for this operation.",
"func":1
},
{
...
"url":4,
"doc":"Delete data products by URL. This method is asynchronous. Attributes: data_source: aurorax.sources.DataSource source associated with the data product records. Identifier, program, platform, and instrument_type are required. urls: list of URL strings associated with the data products being deleted. Returns: 1 on success. Raises: aurorax.exceptions.AuroraXMaxRetriesException: max retry error. aurorax.exceptions.AuroraXUnexpectedContentTypeException: unexpected error. aurorax.exceptions.AuroraXBadParametersException: invalid parameters entered. aurorax.exceptions.AuroraXUnauthorizedException: invalid API key for this operation.",
"func":1
},
{
...
"url":5,
"doc":"Initiate ephemeris search request. Raises: aurorax.exceptions.AuroraXBadParametersException: missing parameters.",
"func":1
},
{
...
"url":5,
"doc":"Delete a range of ephemeris records. This method is asynchronous. Attributes: data_source: aurorax.sources.DataSource source associated with the data product records. Identifier, program, platform, and instrument_type are required. start: datetime.datetime beginning of range to delete records for, inclusive. end: datetime.datetime end of datetime range to delete records for, inclusive. Returns: 1 on success. Raises: aurorax.exceptions.AuroraXMaxRetriesException: max retry error. aurorax.exceptions.AuroraXUnexpectedContentTypeException: unexpected error. aurorax.exceptions.AuroraXNotFoundException: source not found. aurorax.exceptions.AuroraXUnauthorizedException: invalid API key for this operation. aurorax.exceptions.AuroraXBadParametersException: missing parameters.",
"func":1
},
{
...
{
"ref":"aurorax.sources.DataSourceStatistics",
"url":10,
...
{
"ref":"aurorax.sources.DataSourceStatistics.data_source",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.earliest_ephemeris_loaded",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.latest_ephemeris_loaded",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.ephemeris_count",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.earliest_data_product_loaded",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.latest_data_product_loaded",
"url":10,
"doc":""
},
{
"ref":"aurorax.sources.DataSourceStatistics.data_product_count",
"url":10,
"doc":""
},
{
