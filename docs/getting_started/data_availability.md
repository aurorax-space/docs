...
Note that Swarm-Aurora also has this [quick-look availability interface](https://swarm-aurora.com/availability/).

## Availability

The data availability information for AuroraX is visualized using the [Data Availability webpage](https://aurorax.space/data/availability). Below is a screenshot of it. You can look at availability information for ephemeris or data products records, filtering by program if desired. The interface visualizes one year of data at a time.

[![Data availability screenshot](../_extras/img/data_availability_screenshot1.png)](../_extras/img/data_availability_screenshot1.png)
...
You can view the page [here](https://aurorax.space/data/statistics).
...
[Next step&nbsp;&nbsp;:octicons-arrow-right-16:](interacting_programmatically.md){.md-button}
