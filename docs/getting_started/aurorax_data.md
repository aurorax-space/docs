...
1. [ephemeris](../about_the_data/categories.md#ephemeris) records which provide location and operational information for a given ground/space data source
2. [data product](../about_the_data/categories.md#data-products) metadata describing keograms or other summary products (note: no images are stored in the database, only URLs which are used as unique identifiers)

To view what ASI arrays and spacecrafts are currently in AuroraX, you can look at either the [Data Availability](https://aurorax.space/data/availability) webpage or [further documentation we have available](../about_the_data/metadata_in_aurorax.md).
...
Keograms are the most recognizable data product for ground-based ASIs; they are images that represent a period of time for imaging. More information about them can be found [here](../about_the_data/instruments/ground.md#keograms).
...
- [Instrument Descriptions: Ground-based](../about_the_data/instruments/ground.md)
- [Instrument Descriptions: Space-based](../about_the_data/instruments/space.md)
...
[Next step&nbsp;&nbsp;:octicons-arrow-right-16:](what_are_conjunctions.md){.md-button}
